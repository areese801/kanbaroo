...
:class:`~kanbaroo_cli.client.ApiClient` in the same pattern. Centralising
...
from kanbaroo_cli.client import ApiClient
...
def require_config() -> CliConfig:
    ...
    try:
        ...
        _stderr_console.print(
            f"[red]Error:[/red] no Kanbaroo config at {exc.path}.\n"
