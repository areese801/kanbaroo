...
``$KANBAROO_WORKSPACE`` and then to ``default_workspace`` from
...
from kanbaroo_cli.client import ApiClient, ApiRequestError
from kanbaroo_cli.config import CliConfig
from kanbaroo_cli.rendering import stderr_console
...
WORKSPACE_ENV_VAR = "KANBAROO_WORKSPACE"
