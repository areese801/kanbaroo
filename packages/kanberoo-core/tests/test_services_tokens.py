...
from kanberoo_core.auth import hash_token
...
from kanberoo_core.services import tokens as token_service
...
def test_create_token_service_returns_row_and_plaintext(session: Session) -> None:
    """
    The wrapper delegates to :func:`kanberoo_core.auth.create_token` and
