"""
Locate and run the Alembic migrations shipped with kanberoo-core.
...
def alembic_script_location() -> str:
    ...
    """
    pkg_dir = Path(kanberoo_core.__file__).resolve().parent
    ...
    raise FileNotFoundError(
        "Could not locate the kanberoo-core alembic directory. Checked "
