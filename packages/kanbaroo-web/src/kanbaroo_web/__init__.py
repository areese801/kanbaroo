"""
Kanbaroo phase 2 web UI.

This package bundles the static web assets (HTML, CSS, JS) for the Kanbaroo
web UI. It is served by :mod:`kanbaroo_api` via a ``/ui`` static mount when
installed as the ``kanbaroo-api[web]`` extra. See ``docs/spec.md`` section
