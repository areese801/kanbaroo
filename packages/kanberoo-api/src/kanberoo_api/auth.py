...
:class:`~kanberoo_core.actor.Actor`.

Validation happens in :mod:`kanberoo_core.auth` so the CLI and MCP
...
:mod:`kanberoo_api.errors` picks up.
"""
...
def _unauthorized(message: str) -> HTTPException:
    ...
    The custom-handler in :mod:`kanberoo_api.errors` unwraps this into
