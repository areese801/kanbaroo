...
The normalization rules drive the duplicate-title detection across
...
def test_distinct_word_content_does_not_collide() -> None:
    """
    Different word content normalizes to different keys.
    """
...
def test_unicode_letters_and_digits_are_preserved() -> None:
    """
    Letters and digits from any script survive normalization.
    """
