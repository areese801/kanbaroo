...
Models live in :mod:`kanbaroo_core.models` and inherit from :class:`Base`
...
class Base(DeclarativeBase):
    """
    Declarative base for all Kanbaroo ORM models.
    """
...
def new_id() -> str:
    ...
    Kanbaroo uses UUID v7 for all primary keys (see ``docs/spec.md`` section
...
def engine_for_url(url: str, **kwargs: Any) -> Engine:
    """
    Create a SQLAlchemy engine with sensible defaults for Kanbaroo.
