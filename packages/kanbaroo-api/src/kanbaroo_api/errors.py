...
domain exceptions (from :mod:`kanbaroo_core.services.exceptions`);
...
def register_exception_handlers(app: FastAPI) -> None:
    """
    Attach every Kanbaroo error handler to ``app``.

    Called once by :func:`kanbaroo_api.app.create_app` at startup. Order
